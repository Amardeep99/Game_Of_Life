class TestRutenett {
	...
	sjekk("antall naboer i 2x2-rutenett skal være 12, men er " + totaltAntallNaboer, totaltAntallNaboer==12);
	...
	sjekk("antallLevende(): antall levende skal være 3, men er " + testRutenett.antallLevende(),
